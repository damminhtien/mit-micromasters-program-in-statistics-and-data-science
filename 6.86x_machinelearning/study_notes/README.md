...
This index points to the local notes directly. The long filenames are retained for now so that existing history and exported assets remain stable.

> **Legend:** `notes` means local learner-authored material; `incomplete` means the file is a transparent placeholder and should not be mistaken for a finished chapter.

## Course resources

- [Material resources](Material%20Resources%20145b825e496440a2a902cf351f5a65f0.md)
- [Calendar](Calendar%200d59ecbba5ed4f3d9c42e8c8a45566ce.md)
- [Grading policy](Grading%20policy%20c6509bcc7117466a8111b9c5543f8956.md)
...
- [Midterm 1 cheat sheet](Midterm%201%20Cheat%20Sheet%20c1d3c2f659b94d37a9b21cb83ba1e44e.md)
